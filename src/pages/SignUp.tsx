...
import { Mail, Lock, AlertCircle, ArrowRight, Loader2, User } from 'lucide-react';
                ...
                >
                    <motion.div variants={fadeUp} className="mb-6 text-center">
                        <div className="w-14 h-14 bg-[#F5F5F7] rounded-[1rem] flex items-center justify-center mx-auto mb-4">
                            <ArrowRight className="w-6 h-6 text-[#1D1D1F] -rotate-45" strokeWidth={1.5} />
                        </div>
                    ...
                    <motion.div variants={fadeUp} className="relative my-6">
                        ...
                        <div className="relative flex justify-center text-[12px]">
                            <span className="px-4 bg-white text-[#86868B] font-medium tracking-wide uppercase">Or use your email</span>
                        </div>
                    </motion.div>
