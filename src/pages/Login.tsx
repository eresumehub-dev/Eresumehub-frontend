                ...
                >
                    <motion.div variants={fadeUp} className="mb-6 text-center">
                        <div className="w-14 h-14 bg-[#F5F5F7] rounded-[1rem] flex items-center justify-center mx-auto mb-4">
                            <Lock className="w-6 h-6 text-[#1D1D1F]" strokeWidth={1.5} />
                        </div>
                    ...
                    <motion.div variants={fadeUp} className="relative my-6">
                        ...
                        <div className="relative flex justify-center text-[12px]">
                            <span className="px-4 bg-white text-[#86868B] font-medium tracking-wide uppercase">Or continue with email</span>
                        </div>
                    </motion.div>
                    ...
                    <motion.form variants={fadeUp} className="space-y-4" onSubmit={handleSubmit}>
                        ...
                        <div>
                            <div className="flex items-center justify-between mb-1.5 px-1">
                                ...
                                <Link to="/forgot-password" title="Forgot Password" className="text-[12px] font-medium text-[#86868B] hover:text-[#1D1D1F] transition-colors">
                                    Forgot password?
                                </Link>
                            </div>
                            <div className="relative group">
                        ...
                        <div className="pt-1.5">
                            <button
                                type="submit"
                                disabled={loading}
                                className="relative flex w-full justify-center items-center gap-2 rounded-xl bg-[#1D1D1F] px-4 py-3.5 text-[15px] font-medium text-white shadow-[0_8px_20_rgba(0,0,0,0.12)] hover:bg-black active:scale-[0.98] transition-all duration-300 disabled:opacity-70 disabled:cursor-not-allowed overflow-hidden"
                            >
                                {loading ? (
                                    <motion.div 
                                        initial={{ opacity: 0 }} 
                    ...
                    <motion.p variants={fadeUp} className="mt-6 text-center text-[13px] text-[#86868B] font-medium">
                        ...
                        <Link to="/signup" className="text-[#1D1D1F] hover:underline underline-offset-4 transition-all">
                            Create workspace
                        </Link>
                    </motion.p>
                </motion.div>
