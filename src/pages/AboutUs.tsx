                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-16">
                        ...
                        <div>
                            ...
                            <ul className="space-y-4">
                                <li><button onClick={() => navigate('/about')} className="text-[14px] text-[#86868B] hover:text-[#1D1D1F] transition-colors font-medium">About Us</button></li>
                                ...
                                <li><a href="#" className="text-[14px] text-[#86868B] hover:text-[#1D1D1F] transition-colors font-medium">Contact</a></li>
                            </ul>
                        </div>
                        ...
                        <div>
                            ...
                            <ul className="space-y-4">
                                <li><button onClick={() => navigate('/signup')} className="text-[14px] text-[#86868B] hover:text-[#1D1D1F] transition-colors font-medium">AI Resume Builder</button></li>
                                <li><button onClick={() => navigate('/templates')} className="text-[14px] text-[#86868B] hover:text-[#1D1D1F] transition-colors font-medium">Resume Templates</button></li>
                                <li><button onClick={() => navigate('/ats-checker')} className="text-[14px] text-[#86868B] hover:text-[#1D1D1F] transition-colors font-medium">ATS Checker</button></li>
                        ...
                        <div>
                            ...
                            <ul className="space-y-4">
                                <li><a href="#" className="text-[14px] text-[#86868B] hover:text-[#1D1D1F] transition-colors font-medium">Help Center</a></li>
                                <li><a href="#" className="text-[14px] text-[#86868B] hover:text-[#1D1D1F] transition-colors font-medium">Privacy Policy</a></li>
